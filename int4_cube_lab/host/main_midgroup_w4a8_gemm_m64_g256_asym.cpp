#include "aclrtlaunch_midgroup_w4a8_gemm_m64_g256_asym.h"
#include "mg_harness.h"

int main(int argc, char** argv)
{
    return mg::Run(argc, argv, 64, 256, 256, "midgroup_w4a8_gemm_m64_g256_asym",
        [](uint32_t blockDim, aclrtStream stream, void* ahi, void* alo, void* as,
           ...
           uint32_t M, uint32_t N, uint32_t K) {
            ACL_CHECK(aclrtlaunch_midgroup_w4a8_gemm_m64_g256_asym(
